    ...
    <div className="flex flex-col gap-[150px] collection-text">
      ...
      <div className="flex flex-col sm:flex-row items-center mx-auto sm:pl-[0px]">
        <div className="flex flex-col gap-[35px]   ">
          <h5 className="text-[#252B42] font-bold w-[256px]  sm:w-[376px] ">
            {h5}
          </h5>
          <h1 className=" text-[#252B42] sm:text-[58px] text-[40px] font-bold w-[256px]  sm:w-[376px]">
            {h1}
          </h1>
          <h4 className="text-neutral-500 text-xl font-normal w-[226px]  sm:w-[376px] ml-5 sm:ml-0">
            {h4}
          </h4>
          <div className="">
        ...
        <div className="w-[100%] sm:w-[70%] flex justify-end pt-5 sm:pt-0 pl-[100px]">
          <div className="relative flex justify-center items-center">
            <img
              className="w-full sm:max-w-[550px] max-w-100 z-1 mr-20 sm:mr-0"
              src={img}
            />
        ...
        <div className="flex mx-auto gap-5 ">
          <div className="flex flex-col md:flex-row items-center gap-[60px]">
            <div className="flex flex-col gap-[10px] px-[40px] text-center py-3 bg-white">
              ...
              <button className="ml-[23px] border-1  border-[#23A6F0] text-[#23A6F0] w-[189px] h-[54px] px-[36px] py-[15px] rounded-[37px] hover:bg-gray-300">
                Submit Request
              </button>
            </div>
            <div className="flex flex-col gap-[10px] px-[40px] h-[450px] text-center py-3 bg-[#252B42] w">
              ...
              <button className="ml-[23px] border-1  border-[#23A6F0] bg-transparent text-[#23A6F0] w-[189px] h-[54px] px-[36px] py-[15px] rounded-[37px] hover:bg-gray-300">
                Submit Request
              </button>
            </div>
            <div className="flex flex-col gap-[10px] px-[40px] text-center py-3 bg-white">
