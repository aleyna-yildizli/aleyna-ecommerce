        ...
        return (
            ...
            >
                <div className='h-[320px] sm:h-[500px] '>
                    <img src={item} alt={name} className='' />
                </div>
            </CarouselItem>
        );
    });
        ...
        <div className='w-[75%] mx-auto flex flex-col gap-10'>
            ...
            <div className='flex flex-col sm:flex-row gap-8'>
                ...
                <div className='w-full sm:w-1/2 flex flex-col items-start gap-3'>
                    ...
                    <p className='text-[#858585] w-[80%] sm:w-[60%] text-sm font-normal leading-tight tracking-tight'>{descriptionShort}</p>
                    <div className="w-[285px] sm:w-[445px] h-[0px] border border-stone-300"></div>
                    ...
                    <div className='flex gap-2 mt-[19%]'>
                        <button className='text-white text-sm font-bold rounded-sm bg-sky-500 px-[15px] py-[8px] sm:px-[20px] sm:py-[10px]'> Select Options</button>
            ...
            <div className='flex  flex-col sm:flex-row justify-between gap-[30px]'>
                <div className='w-[99%] sm:w-[45%] relative bg-gray-100 rounded-md'>
                    <img className='w-[500px] h-[400px] rounded-md shadow-lg sm:absolute top-0 left-0 object-cover' src={detailImage} />
                </div>
