    ...
    return (
        <div className="flex flex-col sm:py-20 py-5 ">
            ...
            <div className="flex flex-col gap-4 items-center ">
                ...
                <h2 className="text-[#252B42] font-bold sm:text-6xl  text-[40px] sm:leading-[80px] tracking-[0.2px] collection-text">Innovation tailored for you</h2>
            ...
            <div className="flex flex-wrap justify-center mb-[14px]">
                <div>
                    <img src={womanCategory.womanImageOne} className="w-[700px] h-[530px] object-cover mt-2 mr-3" />
                </div>
                <div className="flex gap-2 mt-2">
                    <div className="">
                        <img src={womanCategory.womanImageTwo} className="w-[180px] sm:w-[360px] h-[260px] object-cover mb-[9px] " />
                        <img src={womanCategory.womanImageFour} className="w-[180px] sm:w-[360px]  h-[260px] object-cover mb-[9px]" />
                    </div>
                    <div>
                        <img src={womanCategory.womanImageThree} className="w-[180px] sm:w-[360px]  h-[260px] object-cover mb-[9px]" />
                        <img src={womanCategory.womanImageFive} className="w-[180px] sm:w-[360px]  h-[260px] object-cover mb-[9px]" />
                    </div>
                </div>
            </div>
            {/* Üçüncü section */}
            ...
            <div className="flex flex-col items-center justify-center gap-10 py-[10%]  ">
                <h2 className="text-4xl font-bold w-[240px] sm:w-[480px] ">{socialFooter.h2}</h2>
                <h6 className="text-base font-normal text-[#737373] text-center w-[250px] sm:w-[400px]">{socialFooter.h6}</h6>
