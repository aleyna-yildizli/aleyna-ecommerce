    ...
    return (
        <div>
            <div className="flex flex-col gap-[150px] collection-text">
                ...
                <div className="flex flex-col sm:flex-row items-center mx-auto sm:pl-[180px]  ">
                    <div className="flex flex-col gap-[35px]  w-[276px]  sm:w-[376px]">
                        <h5 className="text-[#252B42] font-bold sm:flex hidden">{h5}</h5>
                        <h1 className=" text-[#252B42] sm:text-[58px] text-[40px] font-bold">{h1}</h1>
                        <h4 className="  text-neutral-500 text-xl font-normal">{h4}</h4>
                        <div className=' justify-start flex '>
                            <button className="text-white text-sm font-bold px-[40px] py-[15px] rounded-[5px] bg-[#23A6F0] mx-[46px] sm:mx-[1px] ">{btnText}</button></div>
                    </div>
                ...
                <div className="flex container flex-col sm:flex-row mx-auto justify-center gap-[100px] text-center ">
                    <div className="">
                ...
                <div className="w-[70%] relative flex items-center justify-center rounded-lg mx-auto">
                    <img className="w-full sm:h-[600px] h-[300px] mx-auto rounded-lg shadow-xl" src={video} alt="Video Thumbnail" />
                ...
                <div className="  bg-[#FAFAFA] py-[80px]">
                    <div className=" flex flex-col gap-3 collection-text">
                        <div className='flex flex-col gap-3 items-center'>
                            <h2 className="text-[#252B42] text-[40px] font-bold  w-[250px] sm:w-[480px] ">{clientsHeader}</h2>
                            <p className="text-[#737373] text-sm font-normal w-[280px] sm:w-[380px] ">{clientsText}</p>
                        </div>
                    </div>
                    <Clients />
                </div>
            ...
            <div className="flex w-full h-[600px] collection-text">
                <div className="flex  w-[100%] sm:w-[70%] bg-[#2A7CC7] justify-center">
                    <div className="w-[60%] sm:w-[60%] flex flex-col my-auto gap-7  ">
                        ...
                        <p className=" w-[100%] sm:w-[70%] text-white text-sm font-normal">{containerText}</p>
                        <div className=' justify-center sm:justify-start flex '>
                            <button className="text-[#FAFAFA] bg-transparent px-[40px] py-[15px] border border-slate-200 rounded-md text-[20px] font-bold mx-[100px]  sm:mx-[1px]">{containerBtn}</button>
                        </div>
                    </div>
                </div>
                <div className="w-[0%] sm:w-[40%] rounded-r-md">
                    <img src={containerImg} className="w-full h-full rounded-r-md sm:flex hidden " />
                </div>
            </div>
        </div>
