    ...
    return (
        ...
        <div className=" w-full flex flex-col-reverse sm:flex-row pt-1 gap-3">
            <div className="basis-1/2 flex justify-end items-end">
                <img src={src} className="w-[414px] h-[407px] sm:w-[670px] sm:h-[682px] " />
            </div>
            <div className="basis-1/2 flex justify-center items-center ">
                <div className="w-[380px] sm:w-[400px] flex flex-col gap-4 collection-text">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                        <button className="button primary-button mx-[100px] sm:mx-0">{buttonTextOne}</button>
                        <button className="button secondary-button mx-[100px] sm:mx-0">{buttonTextTwo}</button>
                    </div>
                </div>
            </div>
        </div>
